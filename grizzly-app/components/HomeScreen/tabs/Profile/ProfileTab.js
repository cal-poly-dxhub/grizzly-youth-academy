...
import { UpdateCadet } from "../../../../queries/queries";
...
export default function ProfileTab() {
  return (
    <StackNavigator.Navigator>
      <StackNavigator.Screen name="Profile" component={ProfileComponent} options={stackNavScreenOpt} />
    </StackNavigator.Navigator>
  );
}
      ...
      <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
        ...
        <Switch
          ...
          onValueChange={async () => {
            ...
            const res = await UpdateCadet(rankingSwitch);
            dispatch({
              type: "SET_CADET_INFO",
              payload: {
                Ranking: Ranking,
